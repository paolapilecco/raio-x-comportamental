...
function generateTasks(): RoadmapTask[] {
  return [
    ...
    // ── LOW ──
    {
      ...
      description: 'CORRIGIDO — Toast de erro e estados visuais adicionados em Dashboard, Profile, CentralReport, DiagnosticHistory e TestCatalog. Queries não falham mais silenciosamente.',
      priority: 'low',
    ...
    },
    {
      ...
      description: 'CORRIGIDO — Loading skeletons personalizados criados para Dashboard, TestCatalog, Profile, CentralReport e DiagnosticHistory, mimetizando a estrutura real de cada página.',
      priority: 'low',
      category: 'improvement',
      status: 'done',
    ...
    },
    {
      ...
      description: 'CORRIGIDO — Responsividade mobile melhorada em Dashboard, CentralReport, Profile, DiagnosticHistory e AdminPrompts. Gráficos, formulários e layouts otimizados para 320px-480px.',
      priority: 'low',
      category: 'improvement',
      status: 'done',
