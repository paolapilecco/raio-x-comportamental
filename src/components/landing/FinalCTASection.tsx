    ...
    <section className="px-6 py-32 md:py-40 bg-background">
      ...
      >
        ...
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-foreground leading-[1.1]">
          Quantas vezes mais você vai repetir o mesmo ciclo{' '}
          <span className="text-muted-foreground">antes de entender o porquê?</span>
        </h2>

        <p className="text-base text-muted-foreground max-w-md mx-auto leading-relaxed">
          5 minutos separam você de finalmente enxergar o que te prende.
          Sua primeira leitura é gratuita — e pode mudar tudo.
        </p>
        ...
        <p className="text-[11px] text-muted-foreground/40 tracking-wide">
          100% gratuito · Sem cartão · Resultado imediato
        </p>
      </motion.div>
    </section>
  );
